...
const isDuplicated = (state, newContact) => {
  console.log("state", state, "new", newContact);
  state.map((contact) => {
    if (
...
export const { addContacts, deletContatct, updateContact } =
  contactSilice.actions;
