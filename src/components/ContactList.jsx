...
import { deletContatct } from "../app/features/counter/counterSlice";
import { useNavigate } from "react-router-dom";
import Thead from "./Thead";

export default function ContactList({ nagigate }) {
  const contactData = useSelector((state) => state.contactList.contacts);
  const dispactch = useDispatch();
  const [searchValue, setSearchValue] = useState("");
  let navigFromEditPage = useNavigate();

  const filteredUsers = contactData.filter((user) =>
          ...
          <div className="flex flex-col">
            <div className=" overflow-x-auto">
              <div className="min-w-full inline-block align-middle">
                <div className="relative  text-gray-500 focus-within:text-gray-900 mb-3 flex justify-between items-center">
                  <div>
                  ...
                  <div>
                    <button
                      onClick={() => nagigate()}
                      className=" flex items-center gap-2 text-white bg-indigo-600 hover:bg-indigo-800 rounded-4xl p-3 w-30 h-10"
                    >
                      {" "}
                      ...
                      {filteredUsers.map((contact, index) => (
                        ...
                        >
                          <td className="p-3 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                            <div className="items-center flex gap-3 overflow-hidden">
                              <img
                              ...
                              <div className="flex flex-col ">
                                ...
                                <span className="text-[11px] text-gray-500 itali  ">
                                  {contact.job}
                                </span>
                              </div>
                            </div>
                          ...
                          <td className=" p-5 ">
                            <div className="flex items-center gap-1">
                              ...
                              <button
                                onClick={() =>
                                  dispactch(deletContatct(contact))
                                }
                                className="p-2 rounded-full  group transition-all duration-500  flex item-center"
                              >
                                <svg
